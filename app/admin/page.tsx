      ...
      <div style={{
        ...
        {allPosts.length === 0 ? (
          <div style={{ padding: '60px', textAlign: 'center', color: '#9ca3af' }}>
            ...
            <p style={{ fontSize: '14px', margin: 0 }}>Henüz yazı yok.</p>
            <Link href="/admin/posts/new" style={{ fontSize: '14px', color: '#111827', fontWeight: 600, marginTop: '8px', display: 'inline-block' }}>
              İlk yazını oluştur →
            </Link>
          </div>
        ) : (
            ...
            <tbody>
              {allPosts.map((post, i) => (
                <tr
                  key={post.id}
                  style={{
                    borderBottom: i < allPosts.length - 1 ? '1px solid #f9fafb' : 'none',
                  }}
                >
