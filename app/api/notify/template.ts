          ...
          <td style="background-color:#111827;padding:22px 40px;border-radius:12px 12px 0 0">
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
              <tr>
                ...
                <td align="right">
                  <span style="font-family:'DM Sans',system-ui,sans-serif;font-size:11px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:0.08em">B&uuml;lten</span>
                </td>
              </tr>
            </table>
          </td>
